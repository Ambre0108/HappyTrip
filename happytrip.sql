...
--
-- Hôte : localhost:8889
-- Généré le : dim. 30 nov. 2025 à 22:42
...
(4, 1, 'FRA', 'bien', 3, '2025-11-30 22:37:49'),
...
(11, 'Belarus', 'Europe', 'BLR', 'La Biélorussie propose forêts, plaines et villes paisibles. Son niveau de bonheur repose sur la simplicité et la tranquillité. Le pays offre un tourisme calme et naturel.', 81),
(12, 'Belgium', 'Europe', 'BEL', 'La Belgique charme par ses villes médiévales, sa culture riche et sa gastronomie réputée incluant chocolats et bières. Son niveau de bonheur est stable grâce à une bonne qualité de vie. Le pays attire les visiteurs intéressés par l histoire, l art et la convivialité.', 18),
...
(14, 'Bhutan', 'Asia', 'BTN', 'Le Bhoutan est mondialement connu pour son Indice de Bonheur National Brut. Entre monastères perchés et montagnes sacrées, il offre un mode de vie centré sur la paix intérieure et l environnement. Une destination rare et profondément inspirante.', 95),
(15, 'Bolivia', 'South America', 'BOL', 'La Bolivie présente certains des paysages les plus impressionnants du continent, dont le Salar de Uyuni et les Andes. Le bonheur repose sur la tradition, la nature et la fierté culturelle. Le pays offre une immersion intense et authentique.', 61),
...
(18, 'Brazil', 'South America', 'BRA', 'Le Brésil séduit par sa joie de vivre, ses plages mythiques, la forêt amazonienne et ses métropoles dynamiques comme Rio de Janeiro. Le bonheur brésilien est porté par la créativité, la musique et la convivialité. Le pays offre une immersion tropicale intense et chaleureuse.', 32),
(19, 'Bulgaria', 'Europe', 'BGR', 'La Bulgarie propose plages, montagnes et monastères historiques. Son niveau de bonheur est variable mais porté par un fort sens de la famille. Le pays offre un excellent rapport qualité voyage.', 97),
...
(22, 'Cambodia', 'Asia', 'KHM', 'Le Cambodge attire par ses temples majestueux comme Angkor Wat, ses paysages paisibles et son atmosphère chaleureuse. Malgré un passé difficile, les habitants affichent un bonheur porté par l optimisme et la solidarité. La destination est marquée par une grande douceur humaine.', 109),
(23, 'Cameroon', 'Africa', 'CMR', 'Le Cameroun, souvent appelé Afrique en miniature, offre montagnes, savanes, plages et forêts tropicales. Son bonheur reflète sa diversité culturelle et son dynamisme. Le pays attire les voyageurs en quête de variété et d authenticité.', 96),
...
(26, 'Chad', 'Africa', 'TCD', 'Le Tchad se distingue par ses paysages sauvages, allant du désert du Sahara au lac Tchad. Le bonheur est influencé par la vie communautaire et la simplicité. C est une destination pour les voyageurs avides d aventures brutes et de nature.', 132),
(27, 'Chile', 'South America', 'CHL', 'Le Chili est un pays longiligne avec une incroyable diversité de paysages, du désert d Atacama à la Patagonie. Son niveau de bonheur augmente grâce à sa stabilité et à la beauté de ses territoires. Une destination unique pour les aventuriers.', 26),
(28, 'China', 'Asia', 'CHN', 'La Chine est un pays immense et fascinant où traditions millénaires et modernité fulgurante coexistent. De la Grande Muraille aux mégapoles futuristes, elle offre une diversité culturelle et géographique unique. Malgré des contrastes sociaux, le niveau de bonheur reflète un fort sentiment d appartenance et une dynamique économique impressionnante.', 93),
(29, 'Colombia', 'South America', 'COL', 'La Colombie surprend par la chaleur humaine de sa population, ses paysages tropicaux et ses villes dynamiques comme Medellín. Le bonheur repose sur l optimisme et l art de vivre colombien. Une destination lumineuse et festive.', 43),
(30, 'Comoros', 'Africa', 'COM', 'Les Comores offrent des plages paradisiaques, une culture métissée et une atmosphère paisible. Le bonheur repose sur la simplicité et la convivialité. L archipel séduit les voyageurs en quête de tranquillité.', 142),
...
(34, 'Croatia', 'Europe', 'HRV', 'La Croatie séduit par ses plages adriatiques, ses villes historiques et sa nature préservée. Son niveau de bonheur progresse grâce à un environnement apaisant et accueillant. Le pays est parfait pour les amateurs de mer et d histoire.', 75),
(35, 'Cyprus', 'Asia', 'CYP', NULL, 49),
(36, 'Czech Republic', 'Europe', 'CZE', 'La Tchéquie, avec Prague comme joyau, allie architecture splendide et qualité de vie agréable. Son bonheur repose sur un équilibre entre histoire et modernité.', 20),
(37, 'Denmark', 'Europe', 'DNK', 'Le Danemark est reconnu pour son mode de vie hygge, son architecture moderne et son niveau de bonheur très élevé. Copenhague attire les voyageurs pour son ambiance détendue et créative. Le pays est un modèle de convivialité et de bien etre.', 2),
(38, 'Dominican Republic', 'North America', 'DOM', 'La République Dominicaine est une destination tropicale réputée pour ses plages paradisiaques, ses resorts et son ambiance festive. Le niveau de bonheur est lié à la musique, la danse et la convivialité. Un incontournable des Caraïbes.', 77),
(39, 'Ecuador', 'South America', 'ECU', 'L Équateur est un petit pays mais d une richesse incroyable, allant des Andes à l Amazonie en passant par les îles Galápagos. Le bonheur y est porté par la diversité culturelle et naturelle. Une destination parfaite pour les explorateurs.', 50),
(40, 'Egypt', 'Africa', 'EGY', 'L Égypte est une destination mythique, berceau de l une des plus anciennes civilisations du monde. Entre temples majestueux, désert et navigation sur le Nil, le pays fascine depuis toujours. Le bonheur des Égyptiens est porté par un sens profond de l hospitalité et une grande richesse culturelle.', 137),
(41, 'El Salvador', 'North America', 'SLV', 'Le Salvador est un pays volcanique offrant plages de surf, montagnes et villages colorés. Le bonheur local repose sur la convivialité et une culture vive. Une destination pleine de surprises.', 35),
(42, 'Estonia', 'Europe', 'EST', NULL, 55),
(43, 'Ethiopia', 'Africa', 'ETH', 'L Éthiopie offre une culture millénaire, des paysages uniques et un niveau de bonheur influencé par la spiritualité et la vie communautaire.', 134),
(44, 'Finland', 'Europe', 'FIN', 'La Finlande, souvent classée pays le plus heureux du monde, séduit par ses lacs, ses forêts et son ambiance paisible. Ses habitants valorisent la nature, le calme et l équilibre. Le pays offre une expérience unique entre modernité et tranquillité.', 1),
...
(51, 'Greece', 'Europe', 'GRC', 'La Grèce attired par ses îles magnifiques, son histoire ancienne et son climat méditerranéen. Son bonheur dépend de la convivialité et du rythme de vie détendu. Le pays est idéal pour un séjour ensoleillé entre culture et détente.', 82),
...
(53, 'Guinea', 'Africa', 'GIN', 'La Guinée séduit par ses forêts, ses montagnes et sa musique influente. Le bonheur est porté par la convivialité et la culture. Le pays offre une authenticité rare et des paysages variés.', 118),
...
(57, 'Hungary', 'Europe', 'HUN', 'La Hongrie est célèbre pour Budapest, ses bains thermaux et son patrimoine architectural. Son niveau de bien etre est en progression. Le pays offre un excellent mélange de culture, détente et histoire.', 62),
(58, 'Iceland', 'Europe', 'ISL', 'L Islande séduit avec ses paysages volcaniques, ses cascades et ses aurores boréales. Son niveau de bonheur élevé reflète une société paisible et connectée à la nature. Le pays offre une expérience de voyage rare et spectaculaire.', 4),
(59, 'India', 'Asia', 'IND', 'L Inde émerveille par sa diversité culturelle, ses temples, ses couleurs et sa spiritualité omniprésente. Ses paysages varient des montagnes de l Himalaya aux plages tropicales. Le niveau de bonheur repose sur la vie communautaire et un profond attachement aux traditions, offrant aux visiteurs une immersion intense et inoubliable.', 140),
(60, 'Indonesia', 'Asia', 'IDN', 'L Indonésie, archipel de plus de 17 000 îles, offre plages paradisiaques, volcans, jungles et cultures variées. Bali, Java ou Sumatra séduisent chaque année des millions de voyageurs. Le bonheur indonésien repose sur la spiritualité, la nature et la convivialité.', 92),
...
(63, 'Ireland', 'Europe', 'IRL', 'L Irlande offre des paysages verdoyants, une culture chaleureuse et une musique traditionnelle vivante. Son niveau de bonheur est porté par une grande convivialité. Le pays attire les amoureux de nature, de légendes et d atmosphères authentiques.', 16),
(64, 'Israel', 'Asia', 'ISR', NULL, 13),
(65, 'Italy', 'Europe', 'ITA', 'L Italie séduit par son patrimoine antique, sa cuisine mondialement connue et ses paysages variés qui s étendent des Dolomites aux plages de Sicile. Son niveau de bonheur repose sur une forte culture familiale et un art de vivre apprécié. Le pays attire les passionnés d histoire et de romantisme.', 36),
(66, 'Ivory Coast', 'Africa', 'CIV', 'La Côte d Ivoire est une destination vibrante, riche en gastronomie, musique et plages. Le bonheur y est porté par la fête, la solidarité et la diversité culturelle. Abidjan et ses alentours offrent une énergie unique et vivante.', 99),
(67, 'Jamaica', 'North America', 'JAM', 'La Jamaïque est le berceau du reggae et un pays tropical réputé pour ses plages et sa culture vibrante. Le bonheur y est fortement lié à la musique et à la philosophie rasta. Une destination colorée et énergique.', 56),
(68, 'Japan', 'Asia', 'JPN', 'Le Japon combine harmonieusement innovation technologique et traditions ancestrales. Temples, jardins zen, gastronomie raffinée et villes ultra modernes en font une destination unique. Son niveau élevé de bien etre se traduit par une société respectueuse, sécurisée et paisible.', 58),
(69, 'Jordan', 'Asia', 'JOR', 'La Jordanie est un joyau du Moyen Orient avec Petra, le désert du Wadi Rum et la mer Morte. Son niveau de bonheur est influencé par une grande hospitalité. Une destination incontournable pour les passionnés d histoire et de nature.', 101),
...
(74, 'Kyrgyzstan', 'Asia', 'KGZ', 'Le Kirghizistan est un paradis pour les amoureux de montagne. Ses traditions nomades et ses paysages immenses créent une atmosphère paisible. Le bonheur local repose sur un rythme de vie simple et harmonieux avec la nature.', 86),
...
(85, 'Malaysia', 'Asia', 'MYS', 'La Malaisie combine modernité, jungles luxuriantes et îles paradisiaques. Sa population multiculturelle lui confère une richesse unique. Le niveau de bonheur reflète un équilibre entre diversité culturelle, nature et confort moderne.', 80),
...
(97, 'Namibia', 'Africa', 'NAM', 'La Namibie est un paradis pour les amateurs de paysages désertiques spectaculaires comme le Namib et ses dunes rouges. Son niveau de bonheur est porté par le calme et la connexion à la nature. Une destination inoubliable.', 113),
...
(99, 'Netherlands', 'Europe', 'NLD', 'Les Pays Bas sont un pays moderne, connu pour ses canaux, ses vélos et son esprit d ouverture. Leur niveau de bonheur élevé reflète une société harmonieuse et progressive. Idéal pour les voyageurs en quête de culture, de nature et de villes innovantes.', 5),
(100, 'New Zealand', 'Oceania', 'NZL', 'La Nouvelle Zélande est célèbre pour ses paysages mythiques entre montagnes, fjords et forêts, ainsi que pour sa population chaleureuse. Son niveau de bonheur est parmi les plus élevés du monde, lié a un mode de vie paisible et tourné vers la nature. Une destination privilégiée pour les amateurs de randonnée, d aventures et de grands espaces.', 8),
...
(105, 'Norway', 'Europe', 'NOR', 'La Norvège est célèbre pour ses fjords spectaculaires, ses montagnes et son niveau de bonheur exceptionnel. Sa qualité de vie et sa nature grandiose attirent les voyageurs en quête d authenticité et de calme. Le pays incarne l harmonie entre homme et nature.', 3),
...
(109, 'Peru', 'South America', 'PER', 'Le Pérou est une terre d histoire, célèbre pour le Machu Picchu, les Andes et sa cuisine parmi les meilleures au monde. Le bonheur péruvien est influencé par la richesse culturelle et la fierté nationale. Le pays offre un voyage intense et mémorable.', 65),
...
(111, 'Poland', 'Europe', 'POL', 'La Pologne combine histoire, modernité et paysages variés. Son niveau de bonheur augmente grâce à un dynamisme culturel et social. Le pays attire les visiteurs curieux de patrimoine et de nature.', 40),
...
(114, 'Romania', 'Europe', 'ROU', 'La Roumanie offre châteaux, Carpates et villages traditionnels. Son niveau de bonheur est porté par la simplicité et la nature. Le pays séduit les voyageurs en quête d authenticité.', 48),
(115, 'Russia', 'Europe', 'RUS', 'La Russie surprend par son immense diversité culturelle et naturelle, avec un bonheur qui varie selon les régions mais une richesse incomparable.', 68),
...
(117, 'Saudi Arabia', 'Asia', 'SAU', 'L Arabie Saoudite propose déserts majestueux, oasis et un patrimoine historique riche. Le niveau de bonheur évolue avec les réformes modernes du pays. Une destination culturelle en plein essor.', 28),
(118, 'Senegal', 'Africa', 'SEN', NULL, 111),
(119, 'Serbia', 'Europe', 'SRB', 'La Serbie propose une culture riche, une gastronomie savoureuse et une hospitalité chaleureuse. Son niveau de bonheur est porté par un mode de vie convivial. Le pays attire les voyageurs curieux d authenticité et de traditions.', 70),
...
(121, 'Singapore', 'Asia', 'SGP', 'Singapour est une cité État moderne, propre et très sécurisée. Son niveau de bonheur élevé provient d une qualité de vie exceptionnelle. Mélange de cultures, jardins futuristes et gastronomie variée en font une destination moderne et surprenante.', 34),
(122, 'Slovakia', 'Europe', 'SVK', 'La Slovaquie propose des montagnes, des châteaux et une culture accueillante. Son niveau de bonheur est en progression grâce à un environnement naturel préservé.', 38),
(123, 'Slovenia', 'Europe', 'SVN', 'La Slovénie est un joyau vert de l Europe, offrant montagnes, lacs et une qualité de vie impressionnante. Son niveau de bonheur reflète une société paisible et proche de la nature.', 44),
(124, 'Somalia', 'Africa', 'SOM', NULL, 112),
(125, 'South Africa', 'Africa', 'ZAF', 'L Afrique du Sud séduit par ses paysages spectaculaires et sa diversité culturelle, avec un niveau de bonheur contrasté mais une énergie unique.', 106),
(126, 'South Korea', 'Asia', 'KOR', 'La Corée du Sud est un pays dynamique mêlant culture pop, technologie et patrimoine historique. Montagnes, palais anciens et cuisine savoureuse en font une destination captivante. Son niveau de bonheur progresse grâce à une qualité de vie en constante amélioration.', 54),
(127, 'South Sudan', 'Africa', 'SSD', 'Le Soudan du Sud possède une nature préservée, de vastes savanes et des traditions ancestrales. Malgré des difficultés internes, le peuple affiche une grande chaleur humaine. Le pays offre une immersion rare dans un environnement authentique.', 156),
(128, 'Spain', 'Europe', 'ESP', 'L Espagne est réputée pour son climat ensoleillé, ses plages, son ambiance festive et ses villes riches en patrimoine. Le pays présente un bon niveau de bonheur, nourri par une culture de convivialité et de détente. Il séduit les voyageurs en quête de soleil et de traditions méditerranéennes.', 30),
...
(130, 'Sweden', 'Europe', 'SWE', 'La Suède se démarque par ses forêts immenses, son design moderne et son bien etre élevé. Sa société harmonieuse et sa nature préservée offrent un cadre idéal pour un voyage serein. Le pays allie innovation et respect de l environnement.', 7),
(131, 'Switzerland', 'Europe', 'CHE', 'La Suisse offre des paysages alpins majestueux, des lacs cristallins et un niveau de bonheur parmi les plus élevés au monde. Le pays est synonyme de sérénité, de qualité de vie et de précision. Ses villes élégantes et sa nature intacte attirent les voyageurs exigeants.', 6),
...
(135, 'Thailand', 'Asia', 'THA', 'La Thaïlande est célèbre pour son ambiance chaleureuse, ses temples dorés, ses îles tropicales et sa cuisine savoureuse. Le pays est souvent associé au sourire, reflet d un bonheur simple et partagé. Une destination parfaite pour la détente et l aventure.', 52),
...
(137, 'Trinidad & Tobago', 'North America', 'TTO', 'Trinidad et Tobago offrent une culture vibrante, des plages tropicales et une scène musicale très riche. Le bonheur repose sur l énergie festive et multiculturelle du pays. Parfait pour les voyageurs en quête d authenticité caribéenne.', 39),
(138, 'Tunisia', 'Africa', 'TUN', 'La Tunisie charme par ses plages méditerranéennes, ses oasis et ses sites archéologiques. Son niveau de bonheur repose sur une vie sociale riche et un climat agréable. Le pays séduit les visiteurs par sa douceur de vivre, sa cuisine parfumée et son patrimoine historique.', 124),
(139, 'Turkey', 'Asia', 'TUR', 'La Turquie offre un mélange unique d Europe et d Asie, de paysages variés et d hospitalité, avec un bonheur influencé par sa culture chaleureuse.', 79),
...
(143, 'United Arab Emirates', 'Asia', 'ARE', 'Les Émirats Arabes Unis allient luxe, modernité et tradition. Dubai et Abu Dhabi offrent confort, sécurité et un niveau de bien etre élevé. Le pays attire les voyageurs à la recherche de modernité et de soleil.', 21),
(144, 'United Kingdom', 'Europe', 'GBR', 'Le Royaume Uni offre un mélange unique de traditions, de culture moderne et de paysages verdoyants, avec un niveau de bonheur stable qui charme les voyageurs.', 15),
...
(147, 'Uzbekistan', 'Asia', 'UZB', 'L Ouzbékistan émerveille par ses villes de la Route de la Soie, ses mosquées bleues et ses traditions millénaires. Le bonheur repose sur un fort sens de l hospitalité. Le pays est idéal pour un voyage culturel d exception.', 41),
...
(149, 'Viet nam', 'Asia', 'VNM', 'Le Vietnam offre une grande diversité de paysages, des rizières en terrasses aux baies spectaculaires. Sa culture riche et sa cuisine appréciée dans le monde entier séduisent les voyageurs. Son niveau de bonheur est porté par la solidarité et la douceur de vivre.', 94),
(159, 'Yemen', 'Asia', 'YEM', NULL, 151),
(160, 'Zambia', 'Africa', 'ZMB', 'La Zambie est une destination de safaris réputée, avec une population accueillante et une nature abondante. Le bonheur est influencé par la tranquillité et les paysages majestueux. Le pays séduit les amateurs d aventures.', 138),

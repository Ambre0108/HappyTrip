...
(37, 'Denemark', 'Europe', 'DNK', 'Le Danemark est reconnu pour son mode de vie hygge, son architecture moderne et son niveau de bonheur très élevé. Copenhague attire les voyageurs pour son ambiance détendue et créative. Le pays est un modèle de convivialité et de bien etre.', 2),
